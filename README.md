...
3. The file “Twitter API.ipynb” holds your starting code for the first half of the assignment. Following this code and the instructions in Chapter 2 of BTAP, pull the descriptions of all followers for each of your artists. 
4. The file “Lyrics Scrape.ipynb” holds your starting code for the second half of the assignment. Follow the instructions in that notebook, pulling and storing the lyrics for both artists. 
